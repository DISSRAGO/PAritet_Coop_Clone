...
const AddressForm: FC<AddressFormProps> = (props) => {
    ...
    useEffect(() => {
        ...
        if (props.defaultAddress?.region?.id != -1) {
            getRegionsList("", props.defaultAddress?.country ?? { id: -1, name: "" });
            setIsDisabledRegion(false);
        }
        if (props.defaultAddress?.city?.id != -1) {
            getCitiesList(
                "",
                props.defaultAddress?.country ?? { id: -1, name: "" },
                props.defaultAddress?.region ?? { id: -1, name: "" },
            );
        ...
        if (props.defaultAddress?.street?.id != -1) {
            getStreetsList(
                ...
                props.defaultAddress?.country ?? { id: -1, name: "" },
                props.defaultAddress?.region ?? { id: -1, name: "" },
                props.defaultAddress?.city ?? { id: -1, name: "" },
            );
        ...
        if (props.defaultAddress?.house?.id != -1) {
            getHousesList(
                ...
                props.defaultAddress?.region ?? { id: -1, name: "" },
                props.defaultAddress?.city ?? { id: -1, name: "" },
                props.defaultAddress?.street ?? { id: -1, name: "" },
            );
