...
def language_types(thanka_type: str) -> dict[str, str]:
    mapping = {
        ...
        # PR P0: раньше product не был в маппинге и отображался как
        # общее «Тханка/тханку/тханки» — в заголовках редактора было
        # «Редактировать тханку» вместо «Редактировать товар».
